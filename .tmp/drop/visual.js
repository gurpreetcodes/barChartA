var customVis91205BB0713146C5AFF802433D87EBDB_DEBUG;
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
const BarChart = ({ filteredData }) => {
    ...
    const [color, setColor] = react__WEBPACK_IMPORTED_MODULE_0__.useState("gray");
    const [minRange, setMinRange] = react__WEBPACK_IMPORTED_MODULE_0__.useState(0);
    const [maxRange, setMaxRange] = react__WEBPACK_IMPORTED_MODULE_0__.useState(100);
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        if (!filteredData.length || !svgRef.current)
            return;
        const svg = d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ltv(svgRef.current);
        svg.selectAll("*").remove();
        const margin = { top: 20, right: 30, bottom: 40, left: 40 };
        const width = 500 - margin.left - margin.right;
        const height = Math.max(5, (filteredData.length * 30) - margin.top - margin.bottom);
        const x = d3__WEBPACK_IMPORTED_MODULE_1__/* .scaleLinear */ .m4Y()
            .domain([0, d3__WEBPACK_IMPORTED_MODULE_1__/* .max */ .T9B(filteredData, d => d.percentage) || 100])
            .range([0, width]);
        const y = d3__WEBPACK_IMPORTED_MODULE_1__/* .scaleBand */ .WH()
        ...
        g.selectAll(".bar")
            ...
            const tooltip = d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ltv("body").append("div")
                .attr("class", "tooltip")
                .style("opacity", 0);
            tooltip.transition()
                .duration(200)
            ...
            d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ltv(".tooltip").remove();
        });
    }, [filteredData, color, minRange, maxRange]);
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "chart-container" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("svg", { ref: svgRef, className: "chart-svg" }),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "inputs-container" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", { type: "text", placeholder: "Enter color", value: color, onChange: e => setColor(e.target.value) }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", { type: "number", placeholder: "Min Range", value: minRange, onChange: e => setMinRange(Number(e.target.value)) }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", { type: "number", placeholder: "Max Range", value: maxRange, onChange: e => setMaxRange(Number(e.target.value)) }))));
};
...
/* harmony import */ var _BarChart__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6631);
...
class Visual {
    ...
    renderReactComponent(filteredData) {
        this.reactRoot = react__WEBPACK_IMPORTED_MODULE_0__.createElement(_BarChart__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A, { filteredData });
...
// This entry need to be wrapped in an IIFE because it declares 'customVis91205BB0713146C5AFF802433D87EBDB_DEBUG' on top-level, which conflicts with the current library output.
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _src_visual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1462);

var powerbiKey = "powerbi";
var powerbi = window[powerbiKey];
var customVis91205BB0713146C5AFF802433D87EBDB_DEBUG = {
    name: 'customVis91205BB0713146C5AFF802433D87EBDB_DEBUG',
    displayName: 'CustomVis',
    class: 'Visual',
    apiVersion: '5.3.0',
    create: (options) => {
...
if (typeof powerbi !== "undefined") {
    ...
    powerbi.visuals.plugins["customVis91205BB0713146C5AFF802433D87EBDB_DEBUG"] = customVis91205BB0713146C5AFF802433D87EBDB_DEBUG;
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (customVis91205BB0713146C5AFF802433D87EBDB_DEBUG);

})();

customVis91205BB0713146C5AFF802433D87EBDB_DEBUG = __webpack_exports__;
/******/ })()
;
